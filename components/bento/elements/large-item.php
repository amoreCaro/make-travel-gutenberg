...
<<?php echo $card_tag; ?><?php echo $card_href; ?>
   class="<?php echo esc_attr($card_class); ?> group lg:col-span-3 bg-white dark:bg-[#18181f] rounded-[24px] md:rounded-[32px] overflow-hidden flex flex-col lg:flex-row min-h-[450px] lg:h-[450px] h-full">
    ...
    <<?php echo $content_tag; ?><?php echo $content_href; ?>
        class="lg:w-[45%] p-4 flex flex-col text-black relative min-h-[300px] lg:min-h-0 lg:h-full overflow-hidden">
        <div class="flex flex-col h-full justify-between">
            <div class="min-h-0">
                <?php if (!empty($category_name)) : ?>
                    <span class="top-4 left-4 flex items-center gap-2 text-[12px] leading-[16px] font-medium capitalize px-3 py-1 rounded-full w-fit mb-3
