...
<header class="header-default fixed top-0 left-0 z-[100] w-full px-5 xl:px-10 h-[80px] flex items-center bg-white text-black dark:bg-black dark:text-white">
    ...
    <?php else : ?>
        ...
        <button
            ...
            class="w-8 h-8 flex items-center justify-center shrink-0 rounded-full bg-[#F2F2F2] text-neutral-900 dark:bg-[#2A2A36] dark:text-white transition-[background-color,color,transform] duration-300 ease-in-out hover:bg-neutral-950 hover:text-white dark:hover:bg-white dark:hover:text-neutral-950"
        >
