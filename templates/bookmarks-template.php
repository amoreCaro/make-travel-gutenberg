...
<main class="bookmarks-page w-full mx-auto pb-24">
    ...
    <div class="w-full mb-10 lg:mb-16">
        <div class="relative h-40 w-full md:h-[288px] 2xl:h-72">
            <img src="<?php echo esc_url($cover_image_url); ?>" class="h-full w-full object-cover" />
        </div>
        ...
        <div class="container -mt-10 lg:-mt-16 mx-auto">
            <div class="relative flex flex-col gap-2 rounded-3xl bg-white p-5 shadow-xl sm:gap-5 md:flex-row md:gap-8 md:rounded-[40px] lg:gap-10 lg:p-8 xl:gap-12 dark:border dark:border-neutral-700 dark:bg-neutral-900">
                ...
                <!-- Avatar -->
                <div class="wil-avatar relative inline-flex shrink-0 items-center justify-center overflow-hidden font-semibold uppercase text-neutral-100 shadow-inner rounded-full w-[144px] h-[144px] text-xl sm:text-3xl lg:text-4xl lg:w-36 lg:h-36 ring-4 ring-white dark:ring-0 shadow-2xl z-0 ring-1 ring-white dark:ring-neutral-900">
                    <img 
                ...
                <!-- Text Content -->
                    <div class="grow">
                        <div class="max-w-(--breakpoint-sm) space-y-3.5">
                                ...
                                <span class="inline-flex items-center text-xl font-semibold sm:text-2xl md:text-3xl lg:text-4xl dark:text-white">
                                    <?php echo esc_html($username); ?>
                                </span>

                                <span class="author_description block text-sm text-neutral-500 dark:text-neutral-400">
                                    
                                    <?php _e("Immerse yourself in the world of literature with our curated collection of books.", THEME); ?>  
                                </span>
    ...
    <!-- GRID -->
    <div id="bookmarks__grid" class="container mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">

        <?php if (!empty($bookmarked_posts) && $query->have_posts()) : ?>
        ...
        <?php else : ?>
            ...
            <p class="col-span-full text-center py-10 text-gray-500 dark:text-neutral-400">
                <?php _e("You haven’t saved any posts yet.", THEME); ?>
            </p>
