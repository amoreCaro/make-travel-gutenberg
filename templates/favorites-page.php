...
<main class="favourites-page w-full mx-auto pb-24">
    ...
    <!-- GRID -->
    <div id="favorites__grid" class="container mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">

        <?php if (!empty($liked_posts) && $query->have_posts()) : ?>
        ...
        <?php else : ?>
            ...
            <p class="col-span-full text-center py-10 text-gray-500">
